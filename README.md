...
- **Key Features**: Auto-resizing, min/max height limits, smooth animations, form validation integration
- **Use Cases**: Message forms, comment boxes, content management systems
- **[📖 Documentation](AutoTextarea/README.md)** | **[🎯 Demo](https://yohn.github.io/Bootstrap-Enhanced-Components/AutoTextarea/Example.html)**
...
- **Key Features**: Dynamic creation, priority queueing, 7 position options, touch gestures, progress indicators
- **Use Cases**: User notifications, status updates, feedback messages, alert systems
- **[📖 Documentation](ToastAlerts/README.md)** | **[🎯 Demo](https://yohn.github.io/Bootstrap-Enhanced-Components/ToastAlerts/Example.html)**
...
- **Key Features**: Real-time formatting, built-in patterns (phone, SSN, credit card), custom validation, Bootstrap integration
...
- **Use Cases**: Image galleries, product showcases, portfolio displays, photo viewers
...
- **Key Features**: Search filtering, option grouping, custom renderers, tag display, bulk operations
- **Use Cases**: Multi-choice forms, filter interfaces, user permissions, category selection
- **[📖 Documentation](MultiSelect/README.md)** | **[🎯 Demo](https://yohn.github.io/Bootstrap-Enhanced-Components/MultiSelect/Example.html)**
...
- **Key Features**: Interaction tracking, bot detection, form analytics, heatmap generation, privacy controls
- **Use Cases**: User analytics, form optimization, security monitoring, UX research
...
- **Key Features**: Nested menu levels, responsive collapse, hover/click triggers, smart positioning
- **Use Cases**: Complex navigation menus, category trees, hierarchical data display
...
- **Key Features**: Multi-page tours, form integration, progress tracking, responsive design, accessibility
- **Use Cases**: User onboarding, feature introduction, tutorial systems, guided workflows
...
- **Key Features**: Visual previews, file validation, multiple display modes, file management, type detection
- **Use Cases**: Media uploads, document management, profile pictures, content creation
- **[📖 Documentation](FileUploadPreview/README.md)** | **[🎯 Demo](https://yohn.github.io/Bootstrap-Enhanced-Components/FileUploadPreview/Example.html)**
___
...
- **Status**: Under development - performance optimizations needed
- **[📖 Documentation](ImageLightbox/README.md)** | **[🎯 Demo](https://yohn.github.io/Bootstrap-Enhanced-Components/ImageLightbox/Example.html)**
...
- **Dark Mode**: Full support for Bootstrap's dark mode
...
- **Configuration Options**: All available options with examples
